...
public final class MecanumDrive {
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose, HardwareQueue hardwareQueue) {
        ...
        leftFront = new PriorityMotor(
                new CachingDcMotorEx(hardwareMap.get(DcMotorEx.class, "leftFront")),
                "leftFront",
                5
        );
        leftBack = new PriorityMotor(
                new CachingDcMotorEx(hardwareMap.get(DcMotorEx.class, "leftRear")),
                "leftBack",
                5
        );
        rightBack = new PriorityMotor(
                new CachingDcMotorEx(hardwareMap.get(DcMotorEx.class, "rightRear")),
                "rightBack",
                5
        );
        rightFront = new PriorityMotor(
                new CachingDcMotorEx(hardwareMap.get(DcMotorEx.class, "rightFront")),
                "rightFront",
                5
        );
        ...
        leftFront.motor[0].setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        leftBack.motor[0].setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        rightBack.motor[0].setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        rightFront.motor[0].setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
...
//        BNO055IMUUtil.remapZAxis(imu, AxisDirection.NEG_Z);
        ...
        localizer = new TwoDeadWheelLocalizer(hardwareMap,this.imu.get(), PARAMS.inPerTick);

        FlightRecorder.write("MECANUM_PARAMS", PARAMS);
    }

    public void driveFromController(GamePadController g1) {
        double input_x = -g1.left_stick_x;
        double input_y = -g1.left_stick_y;
        double input_turn = -g1.right_stick_x;


        if(g1.startOnce()) {
            this.imu.get().resetYaw();
        }
        ...
        Vector2d input = new Vector2d(input_y,input_x);
        input = pose.heading.inverse().times(input); // Field centric
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if (t >= timeTrajectory.duration) {
                leftFront.setTargetPower(0);
                leftBack.setTargetPower(0);
                rightBack.setTargetPower(0);
                rightFront.setTargetPower(0);
