...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 10446.028349068061; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3765.7346517535534; // x position of the perpendicular encoder (in tick units)
    }
