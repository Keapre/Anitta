...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1790.2064912774279; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -740.8817400760353; // x position of the perpendicular encoder (in tick units)
    }
