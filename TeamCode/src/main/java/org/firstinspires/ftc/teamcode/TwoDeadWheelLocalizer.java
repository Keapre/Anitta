...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1874.554346076632; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2118.34757489369; // x position of the perpendicular encoder (in tick units)
    }
